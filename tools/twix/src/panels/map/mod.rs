...
pub struct MapPanel {
    ...
    in_walk_kick_area: EnabledLayer<layers::KickThreshold, Ground>,
}
...
impl Panel for MapPanel {
    ...
    fn new(nao: Arc<Nao>, value: Option<&Value>) -> Self {
        ...
        let in_walk_kick_area = EnabledLayer::new(nao.clone(), value, false);
    ...
    fn save(&self) -> Value {
        json!({
            ...
            "in_walk_kick_area": self.in_walk_kick_area.save(),
        })
    }
}
    ...
    fn ui(self, ui: &mut Ui) -> eframe::egui::Response {
        ui.horizontal(|ui| {
            ui.menu_button("Overlays", |ui| {
                ...
                self.in_walk_kick_area.checkbox(ui);
            });
